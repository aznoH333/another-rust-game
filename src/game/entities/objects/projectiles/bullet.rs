...
fn bullet_new(parameters: &ObjectSummonParameters) -> GameObject {
    ...
    .add_controller(CONTROLLER_TYPE_DESTROYED, Box::new(SpawnGibletsOnDeathController::new(GIBLET_SPLINTER, 1, 2, vec!(Color::new(0.843, 0.451, 0.333, 1.0), Color::new(0.863, 0.961, 1.0, 1.0)))))
    .build();
}
