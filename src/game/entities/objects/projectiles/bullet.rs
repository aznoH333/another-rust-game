...
fn bullet_new(parameters: &ObjectSummonParameters) -> GameObject {
    ...
    .add_controller(CONTROLLER_TYPE_DESTROYED, Box::new(SpawnGibletsOnDeathController::new(GIBLET_SPLINTER, 1, 2, vec!(Color::new(1.0, 0.843, 0.682, 1.0), Color::new(0.667, 0.333, 0.0, 1.0)))))
    .build();
}
