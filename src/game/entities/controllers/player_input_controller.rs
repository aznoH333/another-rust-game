use crate::{engine::{events::{event_manager::EventManager, game_event::GameEvent}, input::input::InputHandler, objects::{engine_animations::{ANIMATION_IDLE, ANIMATION_WALK}, game_object_controller::GameObjectController, game_object_core::GameObjectCore, object_update::ObjectUpdate}, types::object_event::ObjectEvent}, game::entities::objects::projectiles::bullet::Bullet};
